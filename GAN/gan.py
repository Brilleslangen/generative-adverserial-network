...
class Gan:
    ...
    # Either displays or saves 32 images generated by the generator.
    ...
    def generate_images(self, seed, directory=None, filename=None):
        self.generator.eval()
        images = self.generator(seed)
        display_images(images, directory, filename)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if (epoch + 1) % self.display_frequency == 0:
                self.generate_images(benchmark_seed, self.ds_name, f'{self.ds_name}-epoch-{epoch + 1}')
